...
module.exports = function (grunt) { // jshint ignore:line
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both asura.css and asura.min.css
    less  : {
    ...
    uglify: {
      ...
      production: {
        files: {
          'dist/js/asura.min.js': ['dist/js/asura.js']
        }
      }
    },
    ...
    concat: {
      options: {
        ...
        banner   : '/*! Asura app.js\n'
        + '* ================\n'
        + '* Main JS application file for Asura v2. This file\n'
